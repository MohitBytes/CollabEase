        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="d-grid gap-2 d-md-block">
                    <a href="reports?type=projects" class="btn btn-primary">Export Projects</a>
                    <a href="reports?type=tasks" class="btn btn-success ms-2">Export Tasks</a>
                    <a href="reports?type=users" class="btn btn-info ms-2">Export Users</a>
                </div>
            </div>
        </div>
    </div>
